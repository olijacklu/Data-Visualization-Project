...
```{r plot_effort1, fig.width=15, fig.height=12, fig.align='center'}
...
```{r plot_effort2, fig.width=16, fig.height=11, fig.align='center'}
...
education |>
  ...
  labs(title = "Top 10 countries with highest primary out-of-school rate gender disparity",
       subtitle = "Average from 2010-2019",
       shape = "Gender") +
  theme(plot.title = element_text(size = 10.9),
        axis.title.x = element_blank(),
        axis.title.y = element_blank(),
...
```{r plot_effort3_1, fig.width=13, fig.height=11, fig.align='center'}
models <- education |>
  group_by(country) |>
  filter(n() >= 20) |>
  ungroup() |>
...
```{r plot_effort3_2, fig.align='center'}
education |>
...
```{r plot_effort3_3, fig.align='center'}
education |>
